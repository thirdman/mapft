    ...
    <section id="intro" class="row ma-0 ">
      <div class="col col-3 info-column">
        <div class="info-game" v-if="!selectedData">
          <game-info :game="gameData" :expanded="false" v-if="gameData" />
      ...
      <div class="col col-9 content-column">
        <client-only>
          ...
          <div class="map-container" v-if="gameStatus !== 'loading'">
            <div
              class="grid-wrap"
              :style="gameData && gameData.tileMap && gameData.tileMap[0] && `width: ${gameData.tileMap[0].length * 240 + 0}px; height: ${gameData.tileMap.length * 240 + 0}px;`"
              v-if="gameData"
              >
              <Tile
                size="240"
...
export default {
  ...
  methods: {
    ...
    async handleGenerateSelect(location){
    ...
    handleTileSelect(index){
      ...
      if(isNaN(index) || index === this.selectedTile){
        ...
        console.log('we havea a index and tiles', tiles)
        console.log('we havea a index and tiles', tiles[index])
        this.showInfo = true;
