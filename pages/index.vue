      ...
      <div class="primary">
        <div class style="max-width: 700px;">
          ...
          <ul class="heroList">
            ...
            <li>
              <IconLogo size="small" :fillClass="contrastMode" />On-Chain Image Storage
            </li>
            <li>
              <IconLogo size="small" :fillClass="contrastMode" />3D, Audio, and other file types
            </li>
            <li class="soon">
              <IconLogo size="small" :fillClass="contrastMode" />Multiple Images
            </li>
            <li class="soon">
          ...
          <div class="existingUserPrompt">
            ...
            <div class="small">
              <a href="/files/updating_image_links_on_existing_contracts2.pdf" target="_blank">Click here for infomation</a> about migrating to our new image upload toolset.
            </div>
          </div>
          <br />
